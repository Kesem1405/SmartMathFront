...
const DashboardTour = () => {
    ...
    const steps = [
        ...
        {
            target: '.emoji-navbar',
            content: 'זהו התפריט שלך, בעזרתו תוכל לגשת למידע שלך, לחזור לעמוד התרגול, או להתנתק.',
        },
        {
            target: '.sidebar-progress',
            content: 'כאן תוכל לראות את המצב הנוכחי שלך, באיזה נושא אתה כרגע, ובאיזו דרגת קושי אתה.',
            placement: 'left',
        },
        {
